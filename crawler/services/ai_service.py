...
class LocalAIService:
    ...
    def _analyze_sync(self, content: str) -> dict:
        ...
        Đã fix lỗi 'index out of range' và lỗi nhãn Trung tính 0%.
        """
        ...
        try:
            ...
            print(f"[AI WARN] Summary failed, using fallback: {e}")
        ...
        if self._sentiment_pipeline:
            try:
                ...
                raw_output = self._sentiment_pipeline(
                    input_text, 
                    truncation=True, 
                    max_length=256 
                )
                ...
                print(f"[AI ERROR] Sentiment processing failed: {e}")
                sentiment_score = 0.0
                sentiment_label = "Trung tính"
